  ...
  .directive('slideToAccept', function($timeout, $window, $q) {
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        function setNewLitecoinStyle(pct) {
          var translatePct = -2.25 * pct;
          scope.litecoinStyle = getTransformStyle(translatePct);
          curLitecoinPct = pct;
        }
        ...
        function easeSliderPosition(pct) {
          ...
          easePosition(curLitecoinPct, pct, duration, JIGGLE_EASING, function(pct) {
            setNewLitecoinStyle(pct);
          });
        ...
        function jiggleSlider() {
          ...
          var p2 = easePosition(curLitecoinPct, pct, duration, JIGGLE_EASING, function(pct) {
            setNewLitecoinStyle(pct);
          });
        ...
        function recede() {
          ...
          easePosition(curLitecoinPct, 0, duration, easeInOutBack, function(pct) {
            setNewLitecoinStyle(pct);
          });
