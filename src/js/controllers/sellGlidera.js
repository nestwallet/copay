...
angular.module('nestApp.controllers').controller('sellGlideraController', function($scope, $log, $state, $timeout, $ionicHistory, $ionicConfig, lodash, glideraService, popupService, profileService, ongoingProcess, walletService, configService, platformInfo, txFormatService) {
  ...
  $scope.sellConfirm = function() {
    var message = 'Sell litecoin for ' + amount + ' ' + currency;
    var okText = 'Confirm';
