...
angular.module('nestApp.services').factory('buyAndSellService', function($log, nextStepsService, lodash, $ionicScrollDelegate, $timeout) {
  var root = {};
  var services = [];
  var linkedServices = [];
  ...
  root.update = function() {
    ...
    if (linkedServices.length == 0) {
      nextStepsService.register({
        title: 'Buy or Sell Litecoin',
        name: 'buyandsell',
        icon: 'icon-buy-litecoin',
