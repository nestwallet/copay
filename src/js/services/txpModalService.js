...
angular.module('nestApp.services').factory('txpModalService', function(configService, profileService, $rootScope, $ionicModal) {
  ...
  root.open = function(tx) {
    ...
    scope.wallet = wallet;
    scope.nesters = wallet ? wallet.nesters : null;
