...
If you are having particular problem with your Nest instalation, please first [search older 
issues](https://github.com/bitpay/nest/issues) in order to learn if the issue is already reported. It could be fixed already. 

Please also check our [FAQ](https://github.com/bitpay/nest/wiki/NEST---FAQ).
...
provide the following information:
 ...
 - Which version of Nest are you using? (Check Nest version on the side menu)
 ...
 - Please check Nest logs (General Settings -> About Nest -> Session Logs). Look for 
...
To open an issue go to [Github Issues](https://github.com/bitpay/nest/issues).
...
Please adhere to the coding conventions used throughout Nest (indentation, tests, etc.)
